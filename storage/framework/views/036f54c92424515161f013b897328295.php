...
<?php endif; ?>
<?php if($violationClaims->isNotEmpty()): ?>
    <div style="margin-bottom: 1.5rem; display: flex; flex-direction: column; gap: 1rem;">
        ...
        <ul style="display: flex; flex-direction: column; gap: 1rem;">
            <?php $__currentLoopData = $violationClaims; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $claim): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <?php
                ...
                <li style="padding: 1rem 1.25rem; border: 1px solid #e2e8f0; border-radius: 1rem; background: #fff; display: flex; flex-direction: column; gap: 0.75rem;">
                    <div style="display: flex; flex-wrap: wrap; gap: 0.75rem; justify-content: space-between;">
                        <div style="flex: 1 1 220px;">
                            <div style="font-weight: 600; color: #0f172a; margin-bottom: 0.25rem;"><?php echo e(Str::limit(strip_tags($claim->details), 200)); ?></div>
                            <div style="font-size: 0.85rem; color: #64748b;"><?php echo e(optional($claim->created_at)->format('d.m.Y H:i')); ?></div>
                        </div>
                        <span style="align-self: flex-start; padding: 0.35rem 0.75rem; border-radius: 9999px; background: #f1f5f9; font-size: 0.75rem; font-weight: 600; text-transform: uppercase; color: #0f172a;"><?php echo e($statusLabel); ?></span>
                    </div>
                            ...
                            <?php $__currentLoopData = $attachments; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $attachment): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                ...
                                <?php if($downloadUrl): ?>
                                    <div style="display: flex; flex-direction: column; gap: 0.25rem; align-items: flex-start; max-width: 140px;">
                                        <?php if($isImage): ?>
                                            <a href="<?php echo e($downloadUrl); ?>" target="_blank" rel="noopener" style="display: inline-flex; border-radius: 0.75rem; overflow: hidden; border: 1px solid #e2e8f0; width: 72px; height: 72px;">
                                                <img src="<?php echo e($downloadUrl); ?>" alt="<?php echo e($originalName); ?>" style="width: 100%; height: 100%; object-fit: cover;">
                                            </a>
                                        <?php else: ?>
                                            <a href="<?php echo e($downloadUrl); ?>" target="_blank" rel="noopener" style="display: inline-flex; align-items: center; justify-content: center; border-radius: 0.75rem; border: 1px solid #cbd5f5; padding: 0.5rem 0.75rem; font-size: 0.75rem; font-weight: 600; color: #1d4ed8; background: #eef2ff;">
                                                <?php echo e($label); ?>

                                            </a>
                                        <?php endif; ?>
                                        <span style="font-size: 0.75rem; color: #475569; word-break: break-word;"><?php echo e($originalName); ?></span>
                                    </div>
                                <?php else: ?>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /Users/admin/Pictures/html_blade-codex-fix-edit-user-and-edit-account-functionality-50to50/resources/views/user/violation.blade.php ENDPATH**/ ?>