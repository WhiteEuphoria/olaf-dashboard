...
<div class="container">
<div class="grid">
<div class="withdrawal" <?php if($initialMethod): ?> data-initial-method="<?php echo e($initialMethod); ?>" <?php endif; ?>>
...
<div class="field <?php if($cardErrors && $cardErrors->has('from_account_id')): ?> has-error <?php endif; ?>">
    <select name="from_account_id">
        <option value="main" <?php if($selectedAccountOld === 'main'): echo 'selected'; endif; ?>><?php echo e($mainBalanceLabel); ?></option>
        <?php $__currentLoopData = $accountsList; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $account): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            <?php
            ...
            ?>
            <option value="<?php echo e($account->id); ?>" <?php if($selectedAccountOld === $accountOptionValue): echo 'selected'; endif; ?>><?php echo e($accountOptionLabel); ?></option>
        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
    </select>
    <?php if($cardErrors && $cardErrors->has('from_account_id')): ?>
        <span class="error-message"><?php echo e($cardErrors->first('from_account_id')); ?></span>
    <?php endif; ?>
</div>

<?php if($cardErrors && $cardErrors->has('method')): ?>
    <div class="field has-error">
        <span class="error-message"><?php echo e($cardErrors->first('method')); ?></span>
    </div>
<?php endif; ?>

<div class="field <?php if($cardErrors && $cardErrors->has('card.number')): ?> has-error <?php endif; ?>">
...
<?php if($cardErrors && $cardErrors->has('card.number')): ?>
<span class="error-message"><?php echo e($cardErrors->first('card.number')); ?></span>
<?php endif; ?>
</div>
<div class="field <?php if($cardErrors && $cardErrors->has('card.holder')): ?> has-error <?php endif; ?>">
<input name="card[holder]" placeholder="Fullname card holder" type="text" value="<?php echo e(old('card.holder')); ?>" required>
<?php if($cardErrors && $cardErrors->has('card.holder')): ?>
<span class="error-message"><?php echo e($cardErrors->first('card.holder')); ?></span>
<?php endif; ?>
</div>
<div class="field <?php if($cardErrors && $cardErrors->has('amount')): ?> has-error <?php endif; ?>">
<input name="amount" placeholder="Amount" type="number" step="0.01" min="1" value="<?php echo e(old('amount')); ?>" required>
<?php if($cardErrors && $cardErrors->has('amount')): ?>
<span class="error-message"><?php echo e($cardErrors->first('amount')); ?></span>
<?php endif; ?>
</div>
...
<div class="field <?php if($ibanErrors && $ibanErrors->has('from_account_id')): ?> has-error <?php endif; ?>">
    <select name="from_account_id">
        <option value="main" <?php if($selectedAccountOld === 'main'): echo 'selected'; endif; ?>><?php echo e($mainBalanceLabel); ?></option>
        <?php $__currentLoopData = $accountsList; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $account): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            <?php
    ...
    <?php if($ibanErrors && $ibanErrors->has('from_account_id')): ?>
        <span class="error-message"><?php echo e($ibanErrors->first('from_account_id')); ?></span>
    <?php endif; ?>
</div>

<?php if($ibanErrors && $ibanErrors->has('method')): ?>
    <div class="field has-error">
        <span class="error-message"><?php echo e($ibanErrors->first('method')); ?></span>
    </div>
<?php endif; ?>

<div class="field <?php if($ibanErrors && $ibanErrors->has('iban.iban')): ?> has-error <?php endif; ?>">
<input name="iban[iban]" placeholder="Enter IBAN" type="text" value="<?php echo e(old('iban.iban')); ?>" required>
<?php if($ibanErrors && $ibanErrors->has('iban.iban')): ?>
<span class="error-message"><?php echo e($ibanErrors->first('iban.iban')); ?></span>
<?php endif; ?>
</div>
<div class="field <?php if($ibanErrors && $ibanErrors->has('iban.bic')): ?> has-error <?php endif; ?>">
<input name="iban[bic]" placeholder="BIC code" type="text" value="<?php echo e(old('iban.bic')); ?>" required>
<?php if($ibanErrors && $ibanErrors->has('iban.bic')): ?>
<span class="error-message"><?php echo e($ibanErrors->first('iban.bic')); ?></span>
<?php endif; ?>
</div>
<div class="field <?php if($ibanErrors && $ibanErrors->has('iban.holder')): ?> has-error <?php endif; ?>">
<input name="iban[holder]" placeholder="Fullname bank account holder" type="text" value="<?php echo e(old('iban.holder')); ?>" required>
<?php if($ibanErrors && $ibanErrors->has('iban.holder')): ?>
<span class="error-message"><?php echo e($ibanErrors->first('iban.holder')); ?></span>
<?php endif; ?>
</div>
<div class="field <?php if($ibanErrors && $ibanErrors->has('iban.country')): ?> has-error <?php endif; ?>">
<input name="iban[country]" placeholder="Country" type="text" value="<?php echo e(old('iban.country')); ?>" required>
<?php if($ibanErrors && $ibanErrors->has('iban.country')): ?>
<span class="error-message"><?php echo e($ibanErrors->first('iban.country')); ?></span>
<?php endif; ?>
</div>
<div class="field <?php if($ibanErrors && $ibanErrors->has('iban.bank')): ?> has-error <?php endif; ?>">
<input name="iban[bank]" placeholder="Name of the bank" type="text" value="<?php echo e(old('iban.bank')); ?>" required>
<?php if($ibanErrors && $ibanErrors->has('iban.bank')): ?>
<span class="error-message"><?php echo e($ibanErrors->first('iban.bank')); ?></span>
<?php endif; ?>
</div>
<div class="field <?php if($ibanErrors && $ibanErrors->has('amount')): ?> has-error <?php endif; ?>">
<input name="amount" placeholder="Amount" type="number" step="0.01" min="1" value="<?php echo e(old('amount')); ?>" required>
<?php if($ibanErrors && $ibanErrors->has('amount')): ?>
<span class="error-message"><?php echo e($ibanErrors->first('amount')); ?></span>
<?php endif; ?>
</div>
<button class="btn btn--md" type="submit">Withdrawal</button>
</form>
...
<div class="field <?php if($cryptoErrors && $cryptoErrors->has('from_account_id')): ?> has-error <?php endif; ?>">
    <select name="from_account_id">
        <option value="main" <?php if($selectedAccountOld === 'main'): echo 'selected'; endif; ?>><?php echo e($mainBalanceLabel); ?></option>
        <?php $__currentLoopData = $accountsList; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $account): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            <?php
    ...
    <?php if($cryptoErrors && $cryptoErrors->has('from_account_id')): ?>
        <span class="error-message"><?php echo e($cryptoErrors->first('from_account_id')); ?></span>
    <?php endif; ?>
</div>

<?php if($cryptoErrors && $cryptoErrors->has('method')): ?>
    <div class="field has-error">
        <span class="error-message"><?php echo e($cryptoErrors->first('method')); ?></span>
    </div>
<?php endif; ?>

<div class="withdrawal__title">Please complete the information below</div>
<div class="field <?php if($cryptoErrors && $cryptoErrors->has('crypto.address')): ?> has-error <?php endif; ?>">
<input name="crypto[address]" placeholder="Deposit address" type="text" value="<?php echo e(old('crypto.address')); ?>" required>
<?php if($cryptoErrors && $cryptoErrors->has('crypto.address')): ?>
<span class="error-message"><?php echo e($cryptoErrors->first('crypto.address')); ?></span>
<?php endif; ?>
</div>
<div class="field <?php if($cryptoErrors && $cryptoErrors->has('crypto.network')): ?> has-error <?php endif; ?>">
<input name="crypto[network]" placeholder="Network" type="text" value="<?php echo e(old('crypto.network')); ?>" required>
<?php if($cryptoErrors && $cryptoErrors->has('crypto.network')): ?>
<span class="error-message"><?php echo e($cryptoErrors->first('crypto.network')); ?></span>
<?php endif; ?>
</div>
<div class="field <?php if($cryptoErrors && $cryptoErrors->has('crypto.coin')): ?> has-error <?php endif; ?>">
<input name="crypto[coin]" placeholder="Coin" type="text" value="<?php echo e(old('crypto.coin')); ?>" required>
<?php if($cryptoErrors && $cryptoErrors->has('crypto.coin')): ?>
<span class="error-message"><?php echo e($cryptoErrors->first('crypto.coin')); ?></span>
<?php endif; ?>
</div>
<div class="field <?php if($cryptoErrors && $cryptoErrors->has('amount')): ?> has-error <?php endif; ?>">
<input name="amount" placeholder="Amount" type="number" step="0.01" min="1" value="<?php echo e(old('amount')); ?>" required>
<?php if($cryptoErrors && $cryptoErrors->has('amount')): ?>
<span class="error-message"><?php echo e($cryptoErrors->first('amount')); ?></span>
<?php endif; ?>
</div>
<button class="btn btn--md" type="submit">Withdrawal</button>
</form>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /var/www/olaf-dashboard/resources/views/user/withdraw.blade.php ENDPATH**/ ?>