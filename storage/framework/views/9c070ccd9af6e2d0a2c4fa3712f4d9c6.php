...
<?php if($fraudClaims->isNotEmpty()): ?>
    <?php $__currentLoopData = $fraudClaims; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $claim): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
        ...
        ?>
        <div aria-hidden="true" class="popup popup--sm" id="edit-fraud-claim-<?php echo e($claim->id); ?>">
                ...
                <div class="popup__content">
                    ...
                    <div class="modal-content">
                        ...
                        <div class="modal-content__body">
                            <?php if($fraudEditErrors && $isCurrentFraudEdit && $fraudEditErrors->any()): ?>
                                <div style="margin-bottom: 1rem; padding: 0.75rem 1rem; background: #fef2f2; color: #b91c1c; border-radius: 0.75rem;"><?php echo e($fraudEditErrors->first()); ?></div>
                            <?php endif; ?>
                            <form method="POST" action="<?php echo e(route('admin.dashboard.fraud-claims.update', $claim)); ?>" enctype="multipart/form-data">
                                <?php echo csrf_field(); ?>
                                <?php echo method_field('PUT'); ?>
                                <input type="hidden" name="editing_fraud_claim_id" value="<?php echo e($claim->id); ?>">
                                <div class="field">
                                    <textarea name="details" placeholder="Описание" rows="6" required><?php echo e($isCurrentFraudEdit ? old('details') : $claim->details); ?></textarea>
                                    <?php if($isCurrentFraudEdit): ?>
                                        <?php $__errorArgs = ['details', 'fraud_edit'];
                                ...
                                <div class="field">
                                    <select name="status" required>
                                        <?php $__currentLoopData = ['pending' => 'Pending', 'approved' => 'Approved', 'rejected' => 'Rejected']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $value => $label): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <option value="<?php echo e($value); ?>" <?php if(($isCurrentFraudEdit ? old('status') : $claim->status) === $value || ($claim->status === 'В рассмотрении' && $value === 'pending') || ($claim->status === 'Одобрено' && $value === 'approved') || ($claim->status === 'Отклонено' && $value === 'rejected')): echo 'selected'; endif; ?>><?php echo e($label); ?></option>
                                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                    </select>
                                    <?php if($isCurrentFraudEdit): ?>
                                        <?php $__errorArgs = ['status', 'fraud_edit'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
                                    ...
                                    <div class="admin-fraud-attachments">
                                        ...
                                        <ul class="admin-fraud-attachments__list">
                                            <?php $__currentLoopData = $attachments; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $attachment): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                ...
                                                ?>
                                                <li>
                                                    <?php if($attachmentPreviewUrl): ?>
                                                        <button type="button" class="admin-panel__doc-thumb" data-popup="#preview-fraud-attachment-<?php echo e($attachment->id); ?>" title="Открыть превью">
                                                            <img src="<?php echo e($attachmentPreviewUrl); ?>" alt="<?php echo e($attachment->original_name); ?>">
                                                        </button>
                                                    <?php elseif($attachmentExists): ?>
                                                        <a class="admin-panel__doc-thumb admin-panel__doc-thumb--file" href="<?php echo e($attachmentDownloadUrl); ?>" target="_blank" rel="noopener" title="Скачать файл">
                                                            <span><?php echo e($attachment->extensionLabel()); ?></span>
                                                        </a>
                                                    <?php else: ?>
                                                    ...
                                                    <div class="admin-fraud-attachments__meta">
                                                        <span><?php echo e($attachment->original_name ?: basename($attachment->path)); ?></span>
                                                        <?php if($attachmentDownloadUrl): ?>
                                                            <a href="<?php echo e($attachmentDownloadUrl); ?>" style="font-size:0.75rem; color:#0b69b7;" target="_blank" rel="noopener">Скачать</a>
                                                        <?php endif; ?>
                                                    </div>
                                                    <div class="checkbox">
                                                        <input class="checkbox__input" type="checkbox" id="<?php echo e($removeAttachmentId); ?>" name="remove_attachments[]" value="<?php echo e($attachment->id); ?>">
                                                        <label class="checkbox__label" for="<?php echo e($removeAttachmentId); ?>"><span class="checkbox__text">Удалить</span></label>
                                                    </div>
                                                </li>
                                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                        </ul>
...
<?php if($fraudClaims->isNotEmpty()): ?>
    <?php $__currentLoopData = $fraudClaims; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $claim): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
        <?php $__currentLoopData = $claim->attachments; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $attachment): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            <?php
            ...
            ?>
            <?php if($attachmentIsImage && $attachmentPreviewUrl): ?>
                <div aria-hidden="true" class="popup popup--md" id="preview-fraud-attachment-<?php echo e($attachment->id); ?>">
                    <div class="popup__wrapper">
                        <div class="popup__content">
                            <button class="popup__close" data-close type="button">
                                <svg fill="none" height="20" viewBox="0 0 20 20" width="20" xmlns="http://www.w3.org/2000/svg">
                            ...
                            <div class="modal-content" style="max-width:48rem; padding:0; overflow:hidden; background:#0f172a;">
                                <img src="<?php echo e($attachmentPreviewUrl); ?>" alt="<?php echo e($attachment->original_name); ?>" style="width:100%; height:auto; display:block;">
                            </div>
                        </div>
                    </div>
                </div>
...
<?php if($documents->isNotEmpty()): ?>
    <?php $__currentLoopData = $documents; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $document): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
        ...
        ?>
        <div aria-hidden="true" class="popup popup--sm" id="edit-document-<?php echo e($document->id); ?>">
            <div class="popup__wrapper">
                <div class="popup__content">
                    <button class="popup__close" data-close type="button">
                        <svg fill="none" height="20" viewBox="0 0 20 20" width="20" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <div class="modal-content">
                        ...
                        <div class="modal-content__body">
                            <?php if($documentErrors && $isCurrentDocumentEdit && $documentErrors->any()): ?>
                                <div style="margin-bottom: 1rem; padding: 0.75rem 1rem; background: #fef2f2; color: #b91c1c; border-radius: 0.75rem;"><?php echo e($documentErrors->first()); ?></div>
                            <?php endif; ?>
                            <form method="POST" action="<?php echo e(route('admin.dashboard.documents.update', $document)); ?>" enctype="multipart/form-data">
                                <?php echo csrf_field(); ?>
                                <?php echo method_field('PUT'); ?>
                                <input type="hidden" name="editing_document_id" value="<?php echo e($document->id); ?>">
                                <div class="field">
                                    <input name="file" type="file" accept="image/*,application/pdf">
                                    <?php if($isCurrentDocumentEdit): ?>
                                        <?php $__errorArgs = ['file', 'document'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
...
unset($__errorArgs, $__bag); ?>
                                ...
                                <div class="field">
                                    <input name="document_type" type="text" value="<?php echo e(old('document_type', $document->document_type)); ?>" placeholder="Тип документа">
                                    <?php if($isCurrentDocumentEdit): ?>
                                        <?php $__errorArgs = ['document_type', 'document'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
...
unset($__errorArgs, $__bag); ?>
                                ...
                                <div class="field">
                                    <select name="status" data-native>
                                        ...
                                        <?php $__currentLoopData = $documentStatusOptions; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $code => $label): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <option value="<?php echo e($code); ?>" <?php if(old('status', $document->status) === $code): echo 'selected'; endif; ?>><?php echo e($label); ?></option>
                                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                    </select>
                                    <?php if($isCurrentDocumentEdit): ?>
                                        <?php $__errorArgs = ['status', 'document'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
...
unset($__errorArgs, $__bag); ?>
                                ...
                                <?php if($documentPreviewUrl): ?>
                                    <p style="font-size: 0.8rem; color: #63616C; margin-bottom: 1rem;">Текущий файл: <a href="<?php echo e($documentPreviewUrl); ?>" target="_blank" rel="noopener"><?php echo e($document->original_name); ?></a></p>
                                <?php endif; ?>
                                <button class="btn btn--md" type="submit">Сохранить</button>
                            </form>
                        </div>
...
<?php if($documents->isNotEmpty()): ?>
    <?php $__currentLoopData = $documents; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $document): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
        ...
        ?>
        <?php if($documentIsImage && $documentPreviewUrl): ?>
            <div aria-hidden="true" class="popup popup--md" id="preview-document-<?php echo e($document->id); ?>">
                <div class="popup__wrapper">
                    <div class="popup__content">
                        <button class="popup__close" data-close type="button">
                            <svg fill="none" height="20" viewBox="0 0 20 20" width="20" xmlns="http://www.w3.org/2000/svg">
                        ...
                        <div class="modal-content">
                            <div class="modal-content__top">
                                ...
                                <div class="modal-content__text">
                                    ...
                                    <span style="display:block; font-size:0.85rem; color:#63616C;"><?php echo e($formatDate($document->created_at, 'd.m.Y H:i')); ?></span>
                                </div>
                            </div>
                            <div class="modal-content__body">
                                <div style="border-radius: 1rem; overflow: hidden; background: #0f172a;">
                                    <img src="<?php echo e($documentPreviewUrl); ?>" alt="<?php echo e($document->original_name); ?>" style="display:block; width:100%; max-height:70vh; object-fit:contain; background:#0f172a;">
                                </div>
                                <div style="margin-top: 1rem; display:flex; gap:0.75rem; flex-wrap:wrap;">
                                    <a href="<?php echo e($documentPreviewUrl); ?>" target="_blank" rel="noopener" class="btn btn--md">Открыть в новой вкладке</a>
...
<?php if($withdrawals->isNotEmpty()): ?>
    <?php $__currentLoopData = $withdrawals; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $withdrawal): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
        ...
        ?>
        <div aria-hidden="true" class="popup popup--sm" id="edit-withdrawal-<?php echo e($withdrawal->id); ?>">
            <div class="popup__wrapper">
                <div class="popup__content">
                    <button class="popup__close" data-close type="button">
                        <svg fill="none" height="20" viewBox="0 0 20 20" width="20" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <div class="modal-content">
                        ...
                        <div class="modal-content__body">
                            <?php if($withdrawalEditErrors && $isCurrentWithdrawalEdit && $withdrawalEditErrors->any()): ?>
                                <div style="margin-bottom: 1rem; padding: 0.75rem 1rem; background: #fef2f2; color: #b91c1c; border-radius: 0.75rem;"><?php echo e($withdrawalEditErrors->first()); ?></div>
                            <?php endif; ?>
                            <form method="POST" action="<?php echo e(route('admin.dashboard.withdrawals.update', $withdrawal)); ?>">
                                <?php echo csrf_field(); ?>
                                <?php echo method_field('PUT'); ?>
                                <input type="hidden" name="editing_withdrawal_id" value="<?php echo e($withdrawal->id); ?>">
                                <?php
                                ...
                                ?>
                                <div class="field">
                                    <label class="field__label" for="withdrawal-method-<?php echo e($withdrawal->id); ?>">Метод</label>
                                    <select id="withdrawal-method-<?php echo e($withdrawal->id); ?>" name="method" required>
                                        <?php $__currentLoopData = $withdrawalMethods; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $value => $label): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <option value="<?php echo e($value); ?>" <?php if(($isCurrentWithdrawalEdit ? old('method') : $withdrawal->method) === $value): echo 'selected'; endif; ?>><?php echo e(ucfirst($label)); ?></option>
                                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                    </select>
                                    <?php if($isCurrentWithdrawalEdit): ?>
                                        <?php $__errorArgs = ['method', 'withdrawal_edit'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
...
unset($__errorArgs, $__bag); ?>
                                ...
                                <div class="field">
                                    ...
                                    <select name="from_account_id">
                                        <option value="main" <?php if($modalWithdrawalAccount === 'main'): echo 'selected'; endif; ?>><?php echo e($mainBalanceOptionLabel); ?></option>
                                        <?php $__currentLoopData = $accounts; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $account): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            ...
                                            ?>
                                            <option value="<?php echo e($account->id); ?>" <?php if($modalWithdrawalAccount === $optionValue): echo 'selected'; endif; ?>><?php echo e($optionLabel); ?></option>
                                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                    </select>
                                    <?php if($isCurrentWithdrawalEdit): ?>
                                        <?php $__errorArgs = ['from_account_id', 'withdrawal_edit'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
...
unset($__errorArgs, $__bag); ?>
                                ...
                                <div class="field">
                                    <label class="field__label" for="withdrawal-amount-<?php echo e($withdrawal->id); ?>">Сумма</label>
                                    <input id="withdrawal-amount-<?php echo e($withdrawal->id); ?>" name="amount" placeholder="Сумма" type="number" step="0.01" min="0.01" value="<?php echo e($isCurrentWithdrawalEdit ? old('amount') : $withdrawal->amount); ?>" required>
                                    <?php if($isCurrentWithdrawalEdit): ?>
                                        <?php $__errorArgs = ['amount', 'withdrawal_edit'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
...
unset($__errorArgs, $__bag); ?>
                                ...
                                <div class="field">
                                    <label class="field__label" for="withdrawal-status-<?php echo e($withdrawal->id); ?>">Статус</label>
                                    <select id="withdrawal-status-<?php echo e($withdrawal->id); ?>" name="status" required>
                                        <?php $__currentLoopData = ['pending' => 'Pending', 'approved' => 'Approved', 'rejected' => 'Rejected']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $value => $label): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <option value="<?php echo e($value); ?>" <?php if(($isCurrentWithdrawalEdit ? old('status') : $withdrawal->status) === $value): echo 'selected'; endif; ?>><?php echo e($label); ?></option>
                                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                    </select>
                                    <?php if($isCurrentWithdrawalEdit): ?>
                                        <?php $__errorArgs = ['status', 'withdrawal_edit'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
...
unset($__errorArgs, $__bag); ?>
                                ...
                                <div style="display: grid; gap: 0.75rem; margin-top: 1rem;">
                                    ...
                                    <?php $__empty_1 = true; $__currentLoopData = $orderedKeys; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $reqKey): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                        <?php
                                            $value = $formRequisites[$reqKey] ?? '';
                                            $fieldId = 'withdrawal-' . $reqKey . '-' . $withdrawal->id;
                                        ?>
                                        <div class="field">
                                            <label class="field__label" for="<?php echo e($fieldId); ?>"><?php echo e($requisiteLabelFor((string) $reqKey)); ?></label>
                                            <input id="<?php echo e($fieldId); ?>" name="requisites[<?php echo e($reqKey); ?>]" type="text" value="<?php echo e(is_scalar($value) ? $value : json_encode($value, JSON_UNESCAPED_UNICODE)); ?>">
                                        </div>
                                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); if ($__empty_1): ?>
                                        <p style="font-size:0.85rem; color:#63616C;">Реквизиты отсутствуют.</p>
                                    <?php endif; ?>
                                </div>
                                <?php if($withdrawalHasComment): ?>
                                    <div class="field">
                                        <label class="field__label" for="withdrawal-comment-<?php echo e($withdrawal->id); ?>">Комментарий</label>
                                        <textarea id="withdrawal-comment-<?php echo e($withdrawal->id); ?>" name="comment" placeholder="Комментарий" rows="4"><?php echo e($isCurrentWithdrawalEdit ? old('comment') : $withdrawal->comment); ?></textarea>
                                        <?php if($isCurrentWithdrawalEdit): ?>
                                            <?php $__errorArgs = ['comment', 'withdrawal_edit'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
...
<?php if($transactions->isNotEmpty()): ?>
    <?php $__currentLoopData = $transactions; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $transaction): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
        ...
        ?>
        <div aria-hidden="true" class="popup" id="edit-transaction-<?php echo e($transaction->id); ?>">
            <div class="popup__wrapper">
                <div class="popup__content">
                    <button class="popup__close" data-close type="button">
                        <svg fill="none" height="20" viewBox="0 0 20 20" width="20" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <div class="modal-content">
                        ...
                        <div class="modal-content__body">
                            <?php if($transactionErrors && $isCurrentTransactionEdit && $transactionErrors->any()): ?>
                                <div style="margin-bottom: 1rem; padding: 0.75rem 1rem; background: #fef2f2; color: #b91c1c; border-radius: 0.75rem;"><?php echo e($transactionErrors->first()); ?></div>
                            <?php endif; ?>
                            <form method="POST" action="<?php echo e(route('admin.dashboard.transactions.update', $transaction)); ?>">
                                <?php echo csrf_field(); ?>
                                <?php echo method_field('PUT'); ?>
                                <input type="hidden" name="editing_transaction_id" value="<?php echo e($transaction->id); ?>">
                                <?php
                                ...
                                ?>
                                <div class="field">
                                    <input name="created_at" type="datetime-local" value="<?php echo e($isCurrentTransactionEdit ? old('created_at') : optional($transaction->created_at)->format('Y-m-d\TH:i')); ?>" required>
                                    <?php if($isCurrentTransactionEdit): ?>
                                        <?php $__errorArgs = ['created_at', 'transaction'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
...
unset($__errorArgs, $__bag); ?>
                                ...
                                <div class="field">
                                    <select name="account_id">
                                        <option value="main" <?php if($transactionEditAccount === 'main'): echo 'selected'; endif; ?>><?php echo e($mainBalanceOptionLabel); ?></option>
                                        <?php $__currentLoopData = $accounts; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $account): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <?php
                                                $optionValue = (string) $account->id;
                                                $optionLabel = ($account->number ?? '—') . ' • ' . ($account->currency ?? 'EUR') . ' ' . number_format((float) $account->balance, 2, '.', ' ');
                                            ?>
                                            <option value="<?php echo e($account->id); ?>" <?php if($transactionEditAccount === $optionValue): echo 'selected'; endif; ?>>Счёт <?php echo e($optionLabel); ?></option>
                                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                    </select>
                                    <?php if($isCurrentTransactionEdit): ?>
                                        <?php $__errorArgs = ['account_id', 'transaction'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
...
unset($__errorArgs, $__bag); ?>
                                ...
                                <div class="field">
                                    <input name="from" placeholder="От" type="text" value="<?php echo e($isCurrentTransactionEdit ? old('from') : $transaction->from); ?>" required>
                                    <?php if($isCurrentTransactionEdit): ?>
                                        <?php $__errorArgs = ['from', 'transaction'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
...
unset($__errorArgs, $__bag); ?>
                                ...
                                <div class="field">
                                    <input name="to" placeholder="Кому" type="text" value="<?php echo e($isCurrentTransactionEdit ? old('to') : $transaction->to); ?>" required>
                                    <?php if($isCurrentTransactionEdit): ?>
                                        <?php $__errorArgs = ['to', 'transaction'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
...
unset($__errorArgs, $__bag); ?>
                                ...
                                <div class="field">
                                    <select name="type" required>
                                        <?php $__currentLoopData = ['classic' => 'classic', 'fast' => 'fast', 'conversion' => 'conversion', 'hold' => 'hold']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $value => $label): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <option value="<?php echo e($value); ?>" <?php if(($isCurrentTransactionEdit ? old('type') : $transaction->type) === $value): echo 'selected'; endif; ?>><?php echo e($label); ?></option>
                                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                    </select>
                                    <?php if($isCurrentTransactionEdit): ?>
                                        <?php $__errorArgs = ['type', 'transaction'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
...
unset($__errorArgs, $__bag); ?>
                                ...
                                <div class="field">
                                    <input name="amount" placeholder="Сумма" type="number" step="0.01" min="0" value="<?php echo e($isCurrentTransactionEdit ? old('amount') : $transaction->amount); ?>" required>
                                    <?php if($isCurrentTransactionEdit): ?>
                                        <?php $__errorArgs = ['amount', 'transaction'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
...
unset($__errorArgs, $__bag); ?>
                                ...
                                <div class="field">
                                    <select name="status" required>
                                        <?php $__currentLoopData = ['pending' => 'Pending', 'approved' => 'Approved', 'blocked' => 'Blocked', 'hold' => 'Hold']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $value => $label): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <option value="<?php echo e($value); ?>" <?php if(($isCurrentTransactionEdit ? old('status') : $transaction->status) === $value): echo 'selected'; endif; ?>><?php echo e($label); ?></option>
                                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                    </select>
                                    <?php if($isCurrentTransactionEdit): ?>
                                        <?php $__errorArgs = ['status', 'transaction'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
            ...
            <div class="container">
                <div class="admin-panel">
                    ...
                    <div class="admin-panel__block">
                        ...
                        <?php else: ?>
                            <?php if($hasPendingClients): ?>
                                <form method="GET" action="<?php echo e(route('admin.dashboard', [], false)); ?>" class="admin-panel__line" style="gap: 1rem; flex-wrap: wrap; margin-bottom: <?php echo e($hasClients ? '1rem' : '0.5rem'); ?>;" id="admin-dashboard-pending-form">
                                    <div class="admin-panel__field" style="min-width: 220px;">
                                        ...
                                        <select id="admin-dashboard-pending" name="user" class="admin-panel__select" data-submit>
                                            <?php $__currentLoopData = $pendingClientOptions; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $id => $name): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            ...
                            <form method="GET" action="<?php echo e(route('admin.dashboard', [], false)); ?>" class="admin-panel__line" style="gap: 1rem; flex-wrap: wrap;" id="admin-dashboard-user-form">
                                <div class="admin-panel__field" style="min-width: 220px;">
                                    ...
                                    ?>
                                    <select id="admin-dashboard-client" name="user" class="<?php echo e($selectClasses); ?>" data-submit>
                                        <?php $__currentLoopData = $clientOptions; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $id => $name): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            ...
                                            ?>
                                            <option value="<?php echo e($id); ?>" <?php if($selectedUserId === (int) $id): echo 'selected'; endif; ?>><?php echo e($name); ?><?php echo e($statusLabel); ?></option>
                                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                    </select>
                                </div>
                                <?php if($selectedUser): ?>
                            ...
                            <?php if($selectedUser && ! $hasClients): ?>
                            ...
                            <?php if($selectedUser): ?>
                                <div style="margin-top: 0.75rem; display: flex; flex-wrap: wrap; gap: 0.5rem; align-items: center;">
                                    <span style="<?php echo e($statusBadgeStyle($selectedUser->verification_status)); ?>"><?php echo e(strtoupper($selectedUser->verification_status ?? 'PENDING')); ?></span>
                                    <?php if($selectedUserIsPending): ?>
                    ...
                    <div class="admin-panel__block">
                        ...
                        <?php else: ?>
                            <form method="POST" action="<?php echo e(route('admin.dashboard.users.update', $selectedUser)); ?>" id="admin-user-edit-form" data-editing="<?php echo e($userEditActive ? 'true' : 'false'); ?>">
                                <?php echo csrf_field(); ?>
                                <?php echo method_field('PUT'); ?>

                                <div style="display: flex; justify-content: flex-end; gap: 0.5rem; margin-bottom: 1rem;">
                                    <button class="btn btn--md" type="button" data-action="user-edit" <?php if($userEditActive): ?> style="display: none;" <?php endif; ?>>Редактировать</button>
                                    <div data-role="user-edit-actions" style="display: <?php echo e($userEditActive ? 'flex' : 'none'); ?>; gap: 0.5rem;">
                                        <button class="btn btn--md" type="submit">Сохранить</button>
                                        <button class="btn btn--md" type="button" data-action="user-cancel" style="background: #F1F5F9; color: #111827;">Отмена</button>
                                    </div>
                                </div>

                                <?php if($userErrors && $userErrors->any()): ?>
                                    <div style="margin-bottom: 1rem; padding: 0.75rem 1rem; background: #fef2f2; color: #b91c1c; border-radius: 0.75rem;"><?php echo e($userErrors->first()); ?></div>
                                <?php endif; ?>

                                <div class="admin-panel__grid">
                                    <div class="admin-panel__field">
                                        <div class="admin-panel__field-label">Full name</div>
                                        <input class="admin-panel__field-input" name="name" type="text" value="<?php echo e(old('name', $selectedUser->name)); ?>" <?php if (! ($userEditActive)): ?> readonly <?php endif; ?> data-editable>
...
unset($__errorArgs, $__bag); ?>
                                    ...
                                    <div class="admin-panel__field">
                                        ...
                                        <input class="admin-panel__field-info" name="email" type="email" value="<?php echo e(old('email', $selectedUser->email)); ?>" <?php if (! ($userEditActive)): ?> readonly <?php endif; ?> data-editable>
                                        <?php $__errorArgs = ['email', 'user'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
...
unset($__errorArgs, $__bag); ?>
                                    ...
                                    <div class="admin-panel__field">
                                        ...
                                        <select class="admin-panel__field-info" name="verification_status" <?php if (! ($userEditActive)): ?> disabled <?php endif; ?> data-editable="disabled">
                                            <?php $__currentLoopData = ['pending' => 'Pending', 'approved' => 'Approved', 'rejected' => 'Rejected']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $value => $label): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                <option value="<?php echo e($value); ?>" <?php if(old('verification_status', $selectedUser->verification_status) === $value): echo 'selected'; endif; ?>><?php echo e(strtoupper($label)); ?></option>
                                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                        </select>
                                        <?php $__errorArgs = ['verification_status', 'user'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
...
unset($__errorArgs, $__bag); ?>
                                    ...
                                    <div class="admin-panel__field">
                                        ...
                                        <select class="admin-panel__field-info" name="currency" <?php if (! ($userEditActive)): ?> disabled <?php endif; ?> data-editable="disabled">
                                            <?php $__currentLoopData = $currencyOptions; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $code => $label): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                <option value="<?php echo e($code); ?>" <?php if(old('currency', $selectedUser->currency) === $code): echo 'selected'; endif; ?>><?php echo e($label); ?></option>
                                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                        </select>
                                        <?php $__errorArgs = ['currency', 'user'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
...
unset($__errorArgs, $__bag); ?>
                                    ...
                                    <div class="admin-panel__field">
                                        ...
                                        <div style="display: flex; align-items: center; gap: 0.5rem;">
                                            <input class="admin-panel__field-info" name="main_balance" type="number" step="0.01" min="0" value="<?php echo e(old('main_balance', number_format((float) $selectedUser->main_balance, 2, '.', ''))); ?>" <?php if (! ($userEditActive)): ?> readonly <?php endif; ?> data-editable>
                                            <span style="font-size: 0.85rem; font-weight: 600; color: #1F2937;" data-role="user-balance-currency" data-default="<?php echo e($selectedUserCurrency); ?>"><?php echo e($selectedUserCurrency); ?></span>
                                        </div>
                                        <?php $__errorArgs = ['main_balance', 'user'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
...
unset($__errorArgs, $__bag); ?>
                                    ...
                                    <div class="admin-panel__field">
                                        ...
                                        <input class="admin-panel__field-info" name="created_at" type="datetime-local" value="<?php echo e(old('created_at', optional($selectedUser->created_at)->format('Y-m-d\TH:i'))); ?>" <?php if (! ($userEditActive)): ?> disabled <?php endif; ?> data-editable="disabled">
                                        <?php $__errorArgs = ['created_at', 'user'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
                    ...
                    <div class="admin-panel__block">
                        ...
                        <?php else: ?>
                            ...
                            <?php if($selectedAccount): ?>
                                <form method="POST" action="<?php echo e(route('admin.dashboard.accounts.update', $selectedAccount)); ?>" id="admin-account-edit-form" data-editing="<?php echo e($accountEditActive ? 'true' : 'false'); ?>">
                                    <?php echo csrf_field(); ?>
                                    <?php echo method_field('PUT'); ?>
                                    <input type="hidden" name="editing_account_id" value="<?php echo e($selectedAccount->id); ?>">

                                    <div style="display: flex; justify-content: flex-end; gap: 0.5rem; margin-bottom: 1rem;">
                                        <button class="btn btn--md" type="button" data-action="account-edit" <?php if($accountEditActive): ?> style="display: none;" <?php endif; ?>>Редактировать счёт</button>
                                        <div data-role="account-edit-actions" style="display: <?php echo e($accountEditActive ? 'flex' : 'none'); ?>; gap: 0.5rem;">
                                            <button class="btn btn--md" type="submit">Сохранить</button>
                                            <button class="btn btn--md" type="button" data-action="account-cancel" style="background: #F1F5F9; color: #111827;">Отмена</button>
                                        </div>
                                    </div>

                                    <?php if($accountEditErrors && $accountEditErrors->any()): ?>
                                        <div style="margin-bottom: 1rem; padding: 0.75rem 1rem; background: #fef2f2; color: #b91c1c; border-radius: 0.75rem;"><?php echo e($accountEditErrors->first()); ?></div>
                                    <?php endif; ?>

                                    <div class="admin-panel__grid">
                                        <div class="admin-panel__field">
                                            <div class="admin-panel__field-label">Номер счёта</div>
                                            <input class="admin-panel__field-info" name="number" type="text" value="<?php echo e(old('number', $selectedAccount->number)); ?>" <?php if (! ($accountEditActive)): ?> readonly <?php endif; ?> data-editable>
                                            <?php $__errorArgs = ['number', 'account_edit'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
...
unset($__errorArgs, $__bag); ?>
                                        ...
                                        <div class="admin-panel__field">
                                            ...
                                            <select class="admin-panel__field-info" name="status" <?php if (! ($accountEditActive)): ?> disabled <?php endif; ?> data-editable="disabled" data-native>
                                                <?php $__currentLoopData = $accountStatusOptions; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $code => $label): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                    <option value="<?php echo e($code); ?>" <?php if(old('status', $selectedAccount->status) === $code): echo 'selected'; endif; ?>><?php echo e($label); ?></option>
                                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                            </select>
                                            <?php $__errorArgs = ['status', 'account_edit'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
...
unset($__errorArgs, $__bag); ?>
                                        ...
                                        <div class="admin-panel__field">
                                            ...
                                            <select class="admin-panel__field-info" name="type" <?php if (! ($accountEditActive)): ?> disabled <?php endif; ?> data-editable="disabled" data-native>
                                                <?php $__currentLoopData = $accountTypeOptions; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $code => $label): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                    <option value="<?php echo e($code); ?>" <?php if(old('type', $selectedAccount->type) === $code): echo 'selected'; endif; ?>><?php echo e($label); ?></option>
                                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                            </select>
                                            <?php $__errorArgs = ['type', 'account_edit'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
...
unset($__errorArgs, $__bag); ?>
                                        ...
                                        <div class="admin-panel__field">
                                            ...
                                            <input class="admin-panel__field-info" name="organization" type="text" value="<?php echo e(old('organization', $selectedAccount->organization)); ?>" <?php if (! ($accountEditActive)): ?> readonly <?php endif; ?> data-editable>
                                            <?php $__errorArgs = ['organization', 'account_edit'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
...
unset($__errorArgs, $__bag); ?>
                                        ...
                                        <div class="admin-panel__field">
                                            ...
                                            <input class="admin-panel__field-info" name="bank" type="text" value="<?php echo e(old('bank', $selectedAccount->bank)); ?>" <?php if (! ($accountEditActive)): ?> readonly <?php endif; ?> data-editable>
                                            <?php $__errorArgs = ['bank', 'account_edit'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
...
unset($__errorArgs, $__bag); ?>
                                        ...
                                        <div class="admin-panel__field">
                                            ...
                                            <div style="display: flex; align-items: center; gap: 0.5rem;">
                                                <input class="admin-panel__field-info" name="balance" type="number" step="0.01" min="0" value="<?php echo e(old('balance', number_format((float) $selectedAccount->balance, 2, '.', ''))); ?>" <?php if (! ($accountEditActive)): ?> readonly <?php endif; ?> data-editable>
                                                <span style="font-size: 0.85rem; font-weight: 600; color: #1F2937;" data-role="account-balance-currency" data-default="<?php echo e($selectedAccount->currency ?? $selectedUserCurrency); ?>"><?php echo e($selectedAccount->currency ?? $selectedUserCurrency); ?></span>
                                            </div>
                                            <?php $__errorArgs = ['balance', 'account_edit'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
...
unset($__errorArgs, $__bag); ?>
                                        ...
                                        <div class="admin-panel__field">
                                            ...
                                            <select class="admin-panel__field-info" name="currency" <?php if (! ($accountEditActive)): ?> disabled <?php endif; ?> data-editable="disabled" data-native>
                                                <option value="">Как у пользователя (<?php echo e($selectedUserCurrency); ?>)</option>
                                                <?php $__currentLoopData = $currencyOptions; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $code => $label): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                    <option value="<?php echo e($code); ?>" <?php if(old('currency', $selectedAccount->currency) === $code): echo 'selected'; endif; ?>><?php echo e($label); ?></option>
                                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                            </select>
                                            <?php $__errorArgs = ['currency', 'account_edit'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
...
unset($__errorArgs, $__bag); ?>
                                        ...
                                        <div class="admin-panel__field">
                                            ...
                                            <input class="admin-panel__field-info" name="term" type="date" value="<?php echo e(old('term', $selectedAccount && $selectedAccount->term ? \Illuminate\Support\Carbon::parse($selectedAccount->term)->format('Y-m-d') : '')); ?>" <?php if (! ($accountEditActive)): ?> disabled <?php endif; ?> data-editable="disabled">
                                            <?php $__errorArgs = ['term', 'account_edit'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
...
unset($__errorArgs, $__bag); ?>
                                        ...
                                        <div class="admin-panel__field">
                                            ...
                                            <input class="admin-panel__field-info" name="client_initials" type="text" value="<?php echo e(old('client_initials', $selectedAccount->client_initials)); ?>" <?php if (! ($accountEditActive)): ?> readonly <?php endif; ?> data-editable>
                                            <?php $__errorArgs = ['client_initials', 'account_edit'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
...
unset($__errorArgs, $__bag); ?>
                                        ...
                                        <div class="admin-panel__field">
                                            ...
                                            <input class="admin-panel__field-info" name="broker_initials" type="text" value="<?php echo e(old('broker_initials', $selectedAccount->broker_initials)); ?>" <?php if (! ($accountEditActive)): ?> readonly <?php endif; ?> data-editable>
                                            <?php $__errorArgs = ['broker_initials', 'account_edit'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
...
unset($__errorArgs, $__bag); ?>
                                        ...
                                        <div class="admin-panel__field">
                                            ...
                                            <label class="checkbox__label" for="<?php echo e($inlineDefaultId); ?>" style="display: inline-flex; align-items: center; gap: 0.5rem;">
                                                <input class="checkbox__input" id="<?php echo e($inlineDefaultId); ?>" type="checkbox" name="is_default" value="1" <?php if(old('is_default', $selectedAccount->is_default)): echo 'checked'; endif; ?> <?php if (! ($accountEditActive)): ?> disabled <?php endif; ?> data-editable="toggle">
                            ...
                            <?php else: ?>
                                <?php if($selectedAccountValue === 'main'): ?>
                                    <div style="margin-top: 1.5rem; padding: 1rem 1.25rem; border-radius: 1rem; background: #f8fafc; border: 1px solid #e2e8f0;">
                                        <div style="font-size: 0.95rem; font-weight: 600; color: #111827; margin-bottom: 0.5rem;"><?php echo e(__('Main balance')); ?></div>
                                        <div style="display: flex; flex-wrap: wrap; gap: 1.5rem; align-items: baseline;">
                                            <div style="font-size: 1.35rem; font-weight: 700; color: #0f172a;"><?php echo e($formatMoney($selectedUser->main_balance ?? 0, $selectedUserCurrency)); ?></div>
                                            <div style="font-size: 0.85rem; color: #475569;"><?php echo e(__('Источник средств будет списан с основного баланса клиента.')); ?></div>
                                        </div>
                                    </div>
                                <?php endif; ?>
                            <?php endif; ?>
                    ...
                    <div class="admin-panel__block">
                        ...
                        <?php else: ?>
                            <form method="GET" action="<?php echo e(route('admin.dashboard', [], false)); ?>" class="admin-panel__grid admin-panel__grid--entry" style="grid-template-columns: repeat(1, minmax(240px, 1fr));">
                                ...
                                <?php endif; ?>
                                <?php if($selectedWithdrawal): ?>
                                    <input type="hidden" name="withdrawal" value="<?php echo e($selectedWithdrawal->id); ?>">
                                <?php endif; ?>
                                <div class="admin-panel__field">
                                    ...
                                    <select class="admin-panel__field-info" name="transaction" data-submit data-native>
                                        <?php $__currentLoopData = $transactionOptions; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $id => $label): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <option value="<?php echo e($id); ?>" <?php if($selectedTransaction && $selectedTransaction->id === (int) $id): echo 'selected'; endif; ?>><?php echo e($label); ?></option>
                                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                    </select>
                                </div>
                            </form>
                            ...
                            <?php if($selectedTransaction): ?>
                                ...
                                ?>
                                <form method="POST" action="<?php echo e(route('admin.dashboard.transactions.update', $selectedTransaction)); ?>" id="admin-transaction-edit-form" data-editing="<?php echo e($transactionEditActive ? 'true' : 'false'); ?>">
                                    <?php echo csrf_field(); ?>
                                    <?php echo method_field('PUT'); ?>
                                    <input type="hidden" name="editing_transaction_id" value="<?php echo e($selectedTransaction->id); ?>">

                                    <div class="admin-panel__entry">
                                        <div class="admin-panel__entry-header">
                                            <div>
                                                <div class="admin-panel__entry-title"><?php echo e(\Illuminate\Support\Str::upper($selectedTransaction->type ?? 'TRANSACTION')); ?></div>
                                                <div class="admin-panel__entry-subtitle"><?php echo e($datePart); ?> • <?php echo e($timePart); ?></div>
                                            </div>
                                            <div class="admin-panel__entry-actions">
                                                <span class="<?php echo e($chipClass); ?>"><?php echo e($chipLabel); ?></span>
                                            </div>
                                        </div>

                                        <?php if($transactionEditErrors && $transactionEditErrors->any()): ?>
                                            <div style="margin-bottom: 1rem; padding: 0.75rem 1rem; background: #fef2f2; color: #b91c1c; border-radius: 0.75rem;"><?php echo e($transactionEditErrors->first()); ?></div>
                                        <?php endif; ?>

                                        <div class="admin-panel__grid admin-panel__grid--entry">
                                            <div class="admin-panel__field">
                                                <div class="admin-panel__field-label">ID</div>
                                                <input class="admin-panel__field-info" type="text" value="<?php echo e($selectedTransaction->id); ?>" readonly>
                                            </div>
                                            <div class="admin-panel__field">
                                                <div class="admin-panel__field-label">Дата</div>
                                                <input class="admin-panel__field-info" name="created_at" type="datetime-local" value="<?php echo e(old('created_at', optional($selectedTransaction->created_at)->format('Y-m-d\TH:i'))); ?>" data-editable="disabled">
                                                <?php $__errorArgs = ['created_at', 'transaction_edit'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
...
unset($__errorArgs, $__bag); ?>
                                            ...
                                            <div class="admin-panel__field">
                                                ...
                                                <select class="admin-panel__field-info" name="account_id" data-editable="disabled" data-native>
                                                    <option value="main" <?php if($transactionFormAccount === 'main'): echo 'selected'; endif; ?>><?php echo e($mainBalanceOptionLabel); ?></option>
                                                    <?php $__currentLoopData = $accounts; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $account): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                        <?php
                                                            $optionValue = (string) $account->id;
                                                            $optionLabel = ($account->number ?? '—') . ' • ' . ($account->currency ?? 'EUR') . ' ' . number_format((float) $account->balance, 2, '.', ' ');
                                                        ?>
                                                        <option value="<?php echo e($account->id); ?>" <?php if($transactionFormAccount === $optionValue): echo 'selected'; endif; ?>><?php echo e($optionLabel); ?></option>
                                                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                                </select>
                                                <?php $__errorArgs = ['account_id', 'transaction_edit'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
...
unset($__errorArgs, $__bag); ?>
                                            ...
                                            <div class="admin-panel__field">
                                                ...
                                                <input class="admin-panel__field-info" name="amount" type="number" step="0.01" min="0" value="<?php echo e(old('amount', $selectedTransaction->amount)); ?>" data-editable>
                                                <?php $__errorArgs = ['amount', 'transaction_edit'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
...
unset($__errorArgs, $__bag); ?>
                                            ...
                                            <div class="admin-panel__field admin-panel__field--wide">
                                                ...
                                                <input class="admin-panel__field-info" name="from" type="text" value="<?php echo e(old('from', $selectedTransaction->from)); ?>" data-editable>
                                                <?php $__errorArgs = ['from', 'transaction_edit'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
...
unset($__errorArgs, $__bag); ?>
                                            ...
                                            <div class="admin-panel__field admin-panel__field--wide">
                                                ...
                                                <input class="admin-panel__field-info" name="to" type="text" value="<?php echo e(old('to', $selectedTransaction->to)); ?>" data-editable>
                                                <?php $__errorArgs = ['to', 'transaction_edit'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
...
unset($__errorArgs, $__bag); ?>
                                            ...
                                            <div class="admin-panel__field">
                                                ...
                                                <select class="admin-panel__field-info" name="type" data-editable="disabled" data-native>
                                                    <?php $__currentLoopData = $transactionTypeOptions; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $value => $label): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                        <option value="<?php echo e($value); ?>" <?php if(old('type', $selectedTransaction->type) === $value): echo 'selected'; endif; ?>><?php echo e(strtoupper($label)); ?></option>
                                                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                                </select>
                                                <?php $__errorArgs = ['type', 'transaction_edit'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
...
unset($__errorArgs, $__bag); ?>
                                            ...
                                            <div class="admin-panel__field">
                                                ...
                                                <select class="admin-panel__field-info" name="status" data-editable="disabled" data-native>
                                                    <?php $__currentLoopData = $transactionStatusOptions; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $value => $label): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                        <option value="<?php echo e($value); ?>" <?php if(old('status', $selectedTransaction->status) === $value): echo 'selected'; endif; ?>><?php echo e(strtoupper($label)); ?></option>
                                                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                                </select>
                                                <?php $__errorArgs = ['status', 'transaction_edit'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
...
unset($__errorArgs, $__bag); ?>
                                        ...
                                        <div class="admin-panel__entry-actions" data-role="transaction-edit-actions" style="display: <?php echo e($transactionEditActive ? 'flex' : 'none'); ?>; justify-content: flex-end; margin-top: 1rem; gap: 0.5rem;">
                                            <button class="btn btn--md" type="submit">Сохранить</button>
                                        ...
                                        <div class="admin-panel__entry-actions" style="justify-content: flex-end; margin-top: 1rem;">
                                            <button class="btn btn--md" type="button" data-action="transaction-edit" <?php if($transactionEditActive): ?> style="display: none;" <?php endif; ?>>Редактировать</button>
                                        </div>
                                    </div>
                                </form>
                            <?php endif; ?>
                        ...
                        <div style="margin-top: 1rem;">
                            <button class="btn btn--md" type="button" data-popup="#create-transaction-modal" <?php if(! $selectedUser): echo 'disabled'; endif; ?>>Создать транзакцию</button>
                        </div>
                    </div>
                    ...
                    <div class="admin-panel__block">
                        ...
                        <?php else: ?>
                            <form method="GET" action="<?php echo e(route('admin.dashboard', [], false)); ?>" class="admin-panel__grid admin-panel__grid--entry" style="grid-template-columns: repeat(1, minmax(240px, 1fr));">
                                ...
                                <?php endif; ?>
                                <?php if($selectedTransaction): ?>
                                    <input type="hidden" name="transaction" value="<?php echo e($selectedTransaction->id); ?>">
                                <?php endif; ?>
                                <div class="admin-panel__field">
                                    ...
                                    <select class="admin-panel__field-info" name="withdrawal" data-submit data-native>
                                        <?php $__currentLoopData = $withdrawalOptions; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $id => $label): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <option value="<?php echo e($id); ?>" <?php if($selectedWithdrawal && $selectedWithdrawal->id === (int) $id): echo 'selected'; endif; ?>><?php echo e($label); ?></option>
                                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                    </select>
                                </div>
                            </form>
                            ...
                            <?php if($selectedWithdrawal): ?>
                                ...
                                ?>
                                <form method="POST" action="<?php echo e(route('admin.dashboard.withdrawals.update', $selectedWithdrawal)); ?>" id="admin-withdrawal-edit-form" data-editing="<?php echo e($withdrawalEditActive ? 'true' : 'false'); ?>">
                                    <?php echo csrf_field(); ?>
                                    <?php echo method_field('PUT'); ?>
                                    <input type="hidden" name="editing_withdrawal_id" value="<?php echo e($selectedWithdrawal->id); ?>">

                                    <div class="admin-panel__entry">
                                        <div class="admin-panel__entry-header">
                                            <div>
                                                <div class="admin-panel__entry-title"><?php echo e(\Illuminate\Support\Str::upper(__('Withdrawal'))); ?> • <?php echo e(\Illuminate\Support\Str::upper($selectedWithdrawal->method ?? 'CARD')); ?></div>
                                                <div class="admin-panel__entry-subtitle"><?php echo e($datePart); ?> • <?php echo e($timePart); ?></div>
                                            </div>
                                            <div class="admin-panel__entry-actions">
                                                <span class="<?php echo e($chipClass); ?>"><?php echo e($chipLabel); ?></span>
                                        ...
                                        <?php if($withdrawalEditErrors && $withdrawalEditErrors->any()): ?>
                                            <div style="margin-bottom: 1rem; padding: 0.75rem 1rem; background: #fef2f2; color: #b91c1c; border-radius: 0.75rem;"><?php echo e($withdrawalEditErrors->first()); ?></div>
                                        <?php endif; ?>
                                        ...
                                        <div class="admin-panel__grid admin-panel__grid--entry">
                                            <div class="admin-panel__field">
                                                <div class="admin-panel__field-label">ID</div>
                                                <input class="admin-panel__field-info" type="text" value="<?php echo e($selectedWithdrawal->id); ?>" readonly>
                                            </div>
                                            <div class="admin-panel__field">
                                                ...
                                                <select class="admin-panel__field-info" name="from_account_id" data-editable="disabled" data-native>
                                                    <option value="main" <?php if($withdrawalFormAccount === 'main'): echo 'selected'; endif; ?>><?php echo e($mainBalanceOptionLabel); ?></option>
                                                    <?php $__currentLoopData = $accounts; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $account): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                        <?php
                                                            $optionValue = (string) $account->id;
                                                            $optionLabel = ($account->number ?? '—') . ' • ' . ($account->currency ?? 'EUR') . ' ' . number_format((float) $account->balance, 2, '.', ' ');
                                                        ?>
                                                        <option value="<?php echo e($account->id); ?>" <?php if($withdrawalFormAccount === $optionValue): echo 'selected'; endif; ?>><?php echo e($optionLabel); ?></option>
                                                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                                </select>
                                                <?php $__errorArgs = ['from_account_id', 'withdrawal_edit'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
...
unset($__errorArgs, $__bag); ?>
                                            ...
                                            <div class="admin-panel__field">
                                                ...
                                                <select class="admin-panel__field-info" name="method" data-editable="disabled" data-native>
                                                    <?php $__currentLoopData = $withdrawalMethods; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $value => $label): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                        <option value="<?php echo e($value); ?>" <?php if($withdrawalFormMethod === $value): echo 'selected'; endif; ?>><?php echo e(strtoupper($label)); ?></option>
                                                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                                </select>
                                                <?php $__errorArgs = ['method', 'withdrawal_edit'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
...
unset($__errorArgs, $__bag); ?>
                                            ...
                                            <div class="admin-panel__field">
                                                <div class="admin-panel__field-label">Сумма</div>
                                                <input class="admin-panel__field-info" name="amount" type="number" step="0.01" min="0" value="<?php echo e(old('amount', $selectedWithdrawal->amount)); ?>" data-editable>
                                                <?php $__errorArgs = ['amount', 'withdrawal_edit'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
...
unset($__errorArgs, $__bag); ?>
                                            ...
                                            <div class="admin-panel__field">
                                                <div class="admin-panel__field-label">Статус</div>
                                                <select class="admin-panel__field-info" name="status" data-editable="disabled" data-native>
                                                    <?php $__currentLoopData = $withdrawalStatusOptions; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $value => $label): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                        <option value="<?php echo e($value); ?>" <?php if($withdrawalFormStatus === $value): echo 'selected'; endif; ?>><?php echo e(strtoupper($label)); ?></option>
                                                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                                </select>
                                                <?php $__errorArgs = ['status', 'withdrawal_edit'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
...
unset($__errorArgs, $__bag); ?>
                                            ...
                                            <?php if($withdrawalHasComment): ?>
                                                <div class="admin-panel__field admin-panel__field--wide">
                                                    ...
                                                    <input class="admin-panel__field-info" name="comment" type="text" value="<?php echo e($withdrawalFormComment); ?>" data-editable>
                                                    <?php $__errorArgs = ['comment', 'withdrawal_edit'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
...
unset($__errorArgs, $__bag); ?>
                                            ...
                                            ?>
                                            <?php $__currentLoopData = $displayKeys; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $reqKey): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                <?php
                                                    $reqValue = old('requisites.' . $reqKey, $withdrawalFormRequisites->get($reqKey));
                                                ?>
                                                <div class="admin-panel__field admin-panel__field--wide">
                                                    <div class="admin-panel__field-label"><?php echo e($requisiteLabelFor((string) $reqKey)); ?></div>
                                                    <input class="admin-panel__field-info" name="requisites[<?php echo e($reqKey); ?>]" type="text" value="<?php echo e($reqValue); ?>" data-editable>
                                                </div>
                                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                            <?php if($requisiteErrorMessage): ?>
                                                <div class="admin-panel__field admin-panel__field--full" style="border: none; padding: 0;">
                                                    <span class="error-message"><?php echo e($requisiteErrorMessage); ?></span>
                                                </div>
                                            <?php endif; ?>
                                        </div>

                                        <div class="admin-panel__entry-actions" data-role="withdrawal-edit-actions" style="display: <?php echo e($withdrawalEditActive ? 'flex' : 'none'); ?>; justify-content: flex-end; margin-top: 1rem; gap: 0.5rem;">
                                            <button class="btn btn--md" type="submit">Сохранить</button>
                                            <button class="btn btn--md" type="button" data-action="withdrawal-cancel" style="background: #F1F5F9; color: #111827;">Отмена</button>
                                        </div>
                                        <div class="admin-panel__entry-actions" style="justify-content: flex-end; margin-top: 1rem;">
                                            <button class="btn btn--md" type="button" data-action="withdrawal-edit" <?php if($withdrawalEditActive): ?> style="display: none;" <?php endif; ?>>Редактировать</button>
                                        </div>
                                    </div>
                                </form>
                            <?php endif; ?>
                    ...
                    <div class="admin-panel__block">
                        ...
                        <?php else: ?>
                            ...
                            ?>
                            <p class="admin-panel__empty" data-document-empty <?php if($hasDocuments): ?> style="display: none;" <?php endif; ?>>Документы отсутствуют.</p>
                                ...
                                <?php $__currentLoopData = $documents; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $document): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    ...
                                    <li data-document-entry style="display: flex; align-items: center; justify-content: space-between; gap: 1rem; flex-wrap: wrap;">
                                        <div style="display: flex; align-items: center; gap: 0.75rem;">
                                            <?php if($documentPreviewUrl && $documentIsImage): ?>
                                                <button type="button" class="admin-panel__doc-thumb" data-popup="#preview-document-<?php echo e($document->id); ?>" title="Открыть превью">
                                                    <img src="<?php echo e($documentPreviewUrl); ?>" alt="<?php echo e($document->original_name); ?>">
                                                </button>
                                            <?php elseif($documentPreviewUrl): ?>
                                                <a class="admin-panel__doc-thumb admin-panel__doc-thumb--file" href="<?php echo e($documentPreviewUrl); ?>" target="_blank" rel="noopener" title="Открыть файл">
                                                    <span><?php echo e($documentExtensionLabel); ?></span>
                                                </a>
                                            <?php else: ?>
                                                <div class="admin-panel__doc-thumb admin-panel__doc-thumb--empty" title="Файл недоступен">
                                                    <span>Нет файла</span>
                                            ...
                                            <div>
                                                ...
                                                <?php if($document->document_type): ?>
                                                    <div style="font-size: 0.8rem; color: #475569;">Тип: <?php echo e($document->document_type); ?></div>
                                                <?php endif; ?>
                                            </div>
                                        </div>
                                        <div style="display: flex; align-items: center; gap: 0.5rem;">
                                            <span style="<?php echo e($statusBadgeStyle($document->status)); ?>"><?php echo e(strtoupper($document->status ?? 'PENDING')); ?></span>
                                            <button class="btn btn--md" type="button" data-popup="#edit-document-<?php echo e($document->id); ?>">Редактировать</button>
                                        </div>
                                    </li>
                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                            </ul>
                            ...
                            <div class="admin-panel__entry admin-panel__entry--compact" style="margin-top: 1.5rem;">
                                ...
                                <form method="POST" action="<?php echo e(route('admin.dashboard.documents.store')); ?>" enctype="multipart/form-data" class="admin-panel__grid admin-panel__grid--entry" style="margin-top: 1rem;">
                                    <?php echo csrf_field(); ?>
                                    <input type="hidden" name="user_id" value="<?php echo e(old('user_id', $selectedUserId)); ?>">
                                    <div class="admin-panel__field admin-panel__field--full">
                                        ...
                                        ?>
                                        <?php if($documentCreateFileError): ?>
                                            <span class="error-message"><?php echo e($documentCreateFileError); ?></span>
                                        <?php endif; ?>
                                    </div>
                                    <div class="admin-panel__field">
                                        <div class="admin-panel__field-label">Тип документа</div>
                                        <input class="admin-panel__field-info" type="text" name="document_type" value="<?php echo e(old('document_type')); ?>" placeholder="Например, Паспорт">
                                        <?php if($documentCreateErrors && $documentCreateErrors->has('document_type')): ?>
                                            <span class="error-message"><?php echo e($documentCreateErrors->first('document_type')); ?></span>
                                        <?php endif; ?>
                                    </div>
                                    <div class="admin-panel__field">
                                        <div class="admin-panel__field-label">Статус</div>
                                        <?php $createDocumentStatus = old('status', 'pending'); ?>
                                        <select class="admin-panel__field-info" name="status" data-native>
                                            <option value="" <?php if($createDocumentStatus === ''): echo 'selected'; endif; ?>>Без статуса</option>
                                            <?php $__currentLoopData = $documentStatusOptions; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $code => $label): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                <option value="<?php echo e($code); ?>" <?php if($createDocumentStatus === $code): echo 'selected'; endif; ?>><?php echo e($label); ?></option>
                                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                        </select>
                                        <?php if($documentCreateErrors && $documentCreateErrors->has('status')): ?>
                                            <span class="error-message"><?php echo e($documentCreateErrors->first('status')); ?></span>
                                        <?php endif; ?>
                                    </div>
                                    <?php if($documentCreateErrors && $documentCreateErrors->any()): ?>
                                        <div class="admin-panel__field admin-panel__field--full" style="border: none; padding: 0;">
                                            <span class="error-message"><?php echo e($documentCreateErrors->first()); ?></span>
                                        </div>
                                    <?php endif; ?>
                                ...
                                <?php $__currentLoopData = $fraudClaims; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $claim): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <li>
                                            ...
                                            <?php if($attachments->isNotEmpty()): ?>
                                                <div class="admin-fraud-attachments admin-fraud-attachments--compact">
                                                    <?php $__currentLoopData = $attachments; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $attachment): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                        ...
                                                        <?php elseif($attachmentExists): ?>
                                                            <a class="admin-panel__doc-thumb admin-panel__doc-thumb--file" href="<?php echo e($downloadUrl); ?>" target="_blank" rel="noopener" title="Скачать файл">
                                                                <span><?php echo e($attachmentExtLabel); ?></span>
                                                            </a>
                                                        <?php else: ?>
                                                            <div class="admin-panel__doc-thumb admin-panel__doc-thumb--empty" title="Файл недоступен">
                                                                <span>Нет файла</span>
                                        ...
                                        <div style="display: flex; align-items: center; gap: 0.5rem;">
                                            ...
                                            <button class="btn btn--md" type="button" data-popup="#edit-fraud-claim-<?php echo e($claim->id); ?>">Редактировать</button>
                                        </div>
                                    </li>
                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                            </ul>
                    ...
                    <?php if($selectedUser && ! $selectedUser->is_admin): ?>
                        <div class="admin-panel__block" style="border: 1px solid rgba(239, 68, 68, .25); background: #fff1f2;">
                            ...
                            <div data-role="delete-user-confirm" style="display: none; margin-top: 1rem; padding: 1rem; border-radius: 0.75rem; background: #fee2e2; color: #7f1d1d;">
                                ...
                                <div style="display: flex; gap: 0.75rem; flex-wrap: wrap;">
                                    <form method="POST" action="<?php echo e(route('admin.dashboard.users.destroy', $selectedUser)); ?>">
                                        <?php echo csrf_field(); ?>
            ...
            <div class="modal-content modal-content--support">
                ...
                <div class="modal-content__body">
                    <?php if($supportErrors && $supportErrors->any()): ?>
                        <div class="admin-support__alert"><?php echo e($supportErrors->first()); ?></div>
                    <?php endif; ?>

                    <div class="admin-support" data-support-chat
                        data-support-threads-url="<?php echo e(route('admin.dashboard.support.threads')); ?>"
                        data-support-messages-url="<?php echo e(route('admin.dashboard.support.messages')); ?>"
                        data-support-send-url="<?php echo e(route('admin.dashboard.support.messages.store')); ?>"
                        data-selected-user-id="<?php echo e($supportSelectedUserId ?? ''); ?>">
                        <aside class="admin-support__sidebar">
                            <div class="admin-support__new">
                                <form method="GET" class="admin-support__new-form" data-support-create-form>
                                    <?php $__currentLoopData = $supportPersistQuery; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $value): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <input type="hidden" name="<?php echo e($key); ?>" value="<?php echo e($value); ?>">
                                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                    <select name="support_user" class="admin-support__select" data-support-new-select>
                                        <option value="">Новый диалог</option>
                                        <?php $__currentLoopData = $clientOptions; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $id => $name): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <option value="<?php echo e($id); ?>" <?php if((int) $supportSelectedUserId === (int) $id): echo 'selected'; endif; ?>><?php echo e($name); ?> (#<?php echo e($id); ?>)</option>
                                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                    </select>
                            ...
                            <div class="admin-support__threads" data-support-thread-list>
                                <?php $__empty_1 = true; $__currentLoopData = $supportThreads; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $thread): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                    <button type="button"
                                        class="admin-support__thread-btn <?php echo e((int) $supportSelectedUserId === (int) $thread['user_id'] ? 'is-active' : ''); ?>"
                                        data-support-thread
                                        data-user-id="<?php echo e($thread['user_id']); ?>">
                                        <span class="admin-support__thread-name" data-thread-name><?php echo e($thread['name']); ?></span>
                                        <span class="admin-support__thread-meta" data-thread-meta>#<?php echo e($thread['user_id']); ?> · <?php echo e($thread['last_at'] ?? '—'); ?></span>
                                    </button>
                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); if ($__empty_1): ?>
                        ...
                        <section class="admin-support__conversation">
                            <div class="admin-support__conversation-header">
                                <div>
                                    ...
                                    <div class="admin-support__subtitle" data-support-subtitle>
                                        <?php if($supportSelectedUser): ?>
                                            <?php echo e($supportSelectedName); ?> · #<?php echo e($supportSelectedUser->id); ?>
                            ...
                            <div class="admin-support__messages" data-support-messages>
                                <?php $__empty_1 = true; $__currentLoopData = $supportMessages; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $message): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                    <div class="admin-support__bubble <?php echo e(($message['direction'] ?? '') === 'inbound' ? 'admin-support__bubble--admin' : 'admin-support__bubble--client'); ?>">
                                        <div class="admin-support__bubble-meta">
                                            <span class="admin-support__bubble-author">
                                                <?php echo e(($message['direction'] ?? '') === 'inbound' ? 'Администратор' : (($message['user_name'] ?? null) ?: ('User #' . ($message['user_id'] ?? '')))); ?>

                                            </span>
                                            <span class="admin-support__bubble-time"><?php echo e($message['created_at'] ?? ''); ?></span>
                                        </div>
                                        <div class="admin-support__bubble-text"><?php echo nl2br(e($message['message'] ?? '')); ?></div>
                                    </div>
                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); if ($__empty_1): ?>
                                    <div class="admin-support__empty" data-support-empty>
                                        <?php if($supportSelectedUserId): ?>
                            ...
                            <form method="POST" action="<?php echo e(route('admin.dashboard.support')); ?>" class="admin-support__form" data-support-form>
                                <?php echo csrf_field(); ?>
                                <input type="hidden" name="user_id" value="<?php echo e(old('user_id', $supportSelectedUserId)); ?>" data-support-user-input>
                                <div class="field <?php if($supportErrors && $supportErrors->has('message')): ?> has-error <?php endif; ?>">
                                    <textarea name="message" rows="3" placeholder="Введите сообщение..." <?php if(! $supportSelectedUserId): echo 'disabled'; endif; ?>><?php echo e(old('message')); ?></textarea>
...
unset($__errorArgs, $__bag); ?>
                                ...
                                <button class="btn btn--md" type="submit" <?php if(! $supportSelectedUserId): echo 'disabled'; endif; ?>>Отправить</button>
                            </form>
                        </section>
                    </div>
                </div>
                        ...
                        <div class="tabs__content" data-tabs-body>
                            <div class="tabs__body" data-tabs-item <?php if($withdrawalTab !== 'card'): ?> hidden <?php endif; ?>>
                                <form method="POST" action="<?php echo e(route('admin.dashboard.withdrawals.store')); ?>">
                                    ...
                                    <div class="field">
                                        <select name="from_account_id">
                                            <option value="main" <?php if($createWithdrawalAccount === 'main'): echo 'selected'; endif; ?>><?php echo e($mainBalanceOptionLabel); ?></option>
                                            <?php $__currentLoopData = $accounts; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $account): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                <?php
                                                    $optionValue = (string) $account->id;
                                                    $optionLabel = ($account->number ?? '—') . ' • ' . ($account->currency ?? 'EUR') . ' ' . number_format((float) $account->balance, 2, '.', ' ');
                                                ?>
                                                <option value="<?php echo e($account->id); ?>" <?php if($createWithdrawalAccount === $optionValue): echo 'selected'; endif; ?>><?php echo e($optionLabel); ?></option>
                                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                        </select>
                                        <?php $__errorArgs = ['from_account_id', 'withdrawal'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
        ...
        <div class="popup__content">
            ...
            <div class="modal-content">
                ...
                <div class="modal-content__body">
                    ...
                    <?php endif; ?>
                    <form method="POST" action="<?php echo e(route('admin.dashboard.fraud-claims.store')); ?>" enctype="multipart/form-data">
                        <?php echo csrf_field(); ?>
                        <div class="field">
                            <select name="user_id" <?php if(! $hasClients): echo 'disabled'; endif; ?>>
                                <option value="">Выберите клиента</option>
                                <?php $__currentLoopData = $clientOptions; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $id => $name): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <option value="<?php echo e($id); ?>" <?php if(old('user_id', $selectedUserId) == (int) $id): echo 'selected'; endif; ?>><?php echo e($name); ?></option>
                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                            </select>
                        </div>
                        <div class="field">
        ...
        <div class="popup__wrapper">
            <div class="popup__content">
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-content__body">
                        <?php if($transactionErrors && $transactionErrors->any()): ?>
                            <div style="margin-bottom: 1rem; padding: 0.75rem 1rem; background: #fef2f2; color: #b91c1c; border-radius: 0.75rem;"><?php echo e($transactionErrors->first()); ?></div>
                        <?php endif; ?>
                        <form method="POST" action="<?php echo e(route('admin.dashboard.transactions.store')); ?>">
                            <?php echo csrf_field(); ?>
                            ...
                            <div class="field">
                                <select name="account_id">
                                    <option value="main" <?php if($createTransactionAccount === 'main'): echo 'selected'; endif; ?>><?php echo e($mainBalanceOptionLabel); ?></option>
                                    <?php $__currentLoopData = $accounts; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $account): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <?php
                                            $optionValue = (string) $account->id;
                                            $optionLabel = ($account->number ?? '—') . ' • ' . ($account->currency ?? 'EUR') . ' ' . number_format((float) $account->balance, 2, '.', ' ');
                                        ?>
                                        <option value="<?php echo e($account->id); ?>" <?php if($createTransactionAccount === $optionValue): echo 'selected'; endif; ?>><?php echo e($optionLabel); ?></option>
                                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                </select>
                                <?php $__errorArgs = ['account_id', 'transaction'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
...
unset($__errorArgs, $__bag); ?>
                            ...
                            <div class="field">
                                <input name="from" placeholder="От" type="text" value="<?php echo e(old('from')); ?>" required>
                                <?php $__errorArgs = ['from', 'transaction'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
...
unset($__errorArgs, $__bag); ?>
                            ...
                            <div class="field">
                                <input name="to" placeholder="Кому" type="text" value="<?php echo e(old('to')); ?>" required>
                                <?php $__errorArgs = ['to', 'transaction'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
...
unset($__errorArgs, $__bag); ?>
                            ...
                            <div class="field">
                                <select name="type" required>
                                    <?php $__currentLoopData = ['classic' => 'classic', 'fast' => 'fast', 'conversion' => 'conversion', 'hold' => 'hold']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $value => $label): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <option value="<?php echo e($value); ?>" <?php if(old('type') === $value): echo 'selected'; endif; ?>><?php echo e(strtoupper($label)); ?></option>
                                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                </select>
                                <?php $__errorArgs = ['type', 'transaction'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
...
unset($__errorArgs, $__bag); ?>
                            ...
                            <div class="field">
                                <input name="amount" placeholder="Сумма" type="number" step="0.01" min="0.01" value="<?php echo e(old('amount')); ?>" required>
                                <?php $__errorArgs = ['amount', 'transaction'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
...
unset($__errorArgs, $__bag); ?>
                            ...
                            <div class="field">
                                <select name="status" required>
                                    <?php $__currentLoopData = ['pending' => 'Pending', 'approved' => 'Approved', 'blocked' => 'Blocked', 'hold' => 'Hold']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $value => $label): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <option value="<?php echo e($value); ?>" <?php if(old('status') === $value): echo 'selected'; endif; ?>><?php echo e(strtoupper($label)); ?></option>
                                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                </select>
                                <?php $__errorArgs = ['status', 'transaction'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
...
unset($__errorArgs, $__bag); ?>
                            ...
                            <div class="field">
                                <input name="created_at" type="datetime-local" value="<?php echo e(old('created_at', now()->format('Y-m-d\TH:i'))); ?>" required>
                                <?php $__errorArgs = ['created_at', 'transaction'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /Users/admin/Pictures/html_blade-codex-fix-edit-user-and-edit-account-functionality-50to50/resources/views/admin/dashboard.blade.php ENDPATH**/ ?>